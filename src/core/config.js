...
module.exports = {
    ...
    // WhatsApp Client Settings - MEMORY OPTIMIZED & FASTER LOADING
    puppeteer: {
        headless: true,
        ignoreHTTPSErrors: true,
        timeout: 60000, // Tambahkan timeout 60 detik
        slowMo: 0,
        defaultViewport: { width: 1280, height: 720 }, // Viewport lebih besar untuk kompatibilitas
        args: [
            '--no-sandbox', 
    ...
    // Web Version Cache - OPTIMIZED FOR FASTER LOADING
    webVersionCache: {
        type: 'local', // Gunakan cache lokal untuk mempercepat loading
        path: './wa-version.html', // Simpan cache di file lokal
        remotePath: 'https://raw.githubusercontent.com/wppconnect-team/wa-version/main/html/2.2412.54.html',
        fallbackType: 'remote' // Gunakan remote sebagai fallback jika local gagal
    },
